      ...
      <article className="max-w-4xl mx-auto px-6 pb-20 space-y-10">
        ...
        <section className="space-y-4">
          ...
          <ul className="list-disc pl-6 text-[#b3c0d8] space-y-2 text-sm">
            <li>국가시장감독관리총국, "중화인민공화국 광고법(2021년 개정)" — 제18조 건강식품 광고의 절대적 표현 금지, 제16조 의료기기 광고 사전 승인 요구.</li>
            <li>Frost & Sullivan, "중국 헬스케어 시장 보고서 2025" — 중국 헬스케어 광고 지출 890억 위안, 디지털 채널 62% 비중.</li>
            <li>국가약품감독관리국, "건강식품 광고 가이드라인 2025" — 의무 면책 조항 텍스트 및 금지 표현 목록 2025년 업데이트.</li>
          </ul>
