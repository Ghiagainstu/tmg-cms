      ...
      <article className="max-w-4xl mx-auto px-6 pb-20 space-y-10">
        ...
        <section className="space-y-4">
          ...
          <ul className="list-disc pl-6 text-[#b3c0d8] space-y-2 text-sm">
            <li>国家市場監督管理総局「中華人民共和国広告法（2021年改正）」— 第18条は健康食品は健康食品広告での絶対的表現を禁止、第16条は医療機器広告の事前承認を要求。</li>
            <li>Frost & Sullivan「中国ヘルスケア市場レポート2025」— 中国のヘルスケア広告支出は890億元、デジタルチャネルが62%を占める。</li>
            <li>国家薬品監督管理局「健康食品広告ガイドライン2025」— 義務的免責事項テキストと禁止表現リストを2025年更新。</li>
          </ul>
