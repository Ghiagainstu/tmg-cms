      ...
      <article className="max-w-4xl mx-auto px-6 pb-20 space-y-10">
        ...
        <section className="space-y-4">
          ...
          <ul className="list-disc pl-6 text-[#b3c0d8] space-y-2 text-sm">
            <li>QuestMobile「中国ショートビデオ産業レポート2025」— ショートビデオプラットフォームの合計月間アクティブユーザーは10億人に到達。</li>
            <li>快手2024年次報告 — 月間アクティブユーザー7.14億人、ライブコマースGMVは前年比30%成長。</li>
            <li>小紅書公式「REDコマースエコシステム2025」— MAU3.2億人突破、コンテンツ→購入のCVRは業界平均の2倍。</li>
          </ul>
