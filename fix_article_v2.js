...
// 3. Add article-table BEFORE the TMG \u8996\u70b9 H2 tag (find the full <h2> tag)
const tmgH2Search = "\ud83c\udfaf TMG\u306e\u8996\u70b9\uff1a\u30e2\u30c7\u30eb\u3060\u3051\u306e\u554f\u984c\u3067\u306f\u306a\u3044";
const tmgH2Idx = c.indexOf(tmgH2Search);
// Find the <h2 that contains this text
const tmgH2Start = c.lastIndexOf("<h2", tmgH2Idx);
...
c = c.substring(0, tmgH2Start) + tableHTML + c.substring(tmgH2Start);

// 4. Add takeaway-banner BEFORE the CTA H2 tag
const ctaSearch = "\u5e83\u544a\u4e88\u7b97\u3092\u3082\u3063\u3068\u8ce2\u304f\u4f7f\u3046\u6e96\u5099\u306f\u3067\u304d\u307e\u3057\u305f\u304b\uff1f";
const ctaH2Idx = c.indexOf(ctaSearch);
const ctaH2Start = c.lastIndexOf("<h2", ctaH2Idx);
...
c = c.substring(0, ctaH2Start) + bannerHTML + c.substring(ctaH2Start);
...
console.log("\nEncoding checks:");
console.log("\u652f\u6257\u3044 present: " + c.includes("\u652f\u6257\u3044\u30bf\u30a4\u30df\u30f3\u30b0"));
console.log("\u8a90\u6b3a check: " + (c.includes("\u30af\u30ea\u30c3\u30af\u8a90\u6b3a") ? "OK" : "NEEDS FIX"));
