const fs = require("fs");
const c = fs.readFileSync(String.raw`C:\Users\fireh\WorkBuddy\20260326144402\tmg-website\ja\blog\pangle-ads.html`, "utf8");
...
h1s.forEach(h => { var t = h[1].replace(/<[^>]+>/g, ""); if (/^[A-Z]/.test(t) && /[a-z]/.test(t) && !/[\u3040-\u309F\u30A0-\u30FF\u4E00-\u9FFF]/.test(t)) console.log("ENG H1: " + t); });

// Article end
var artEnd = c.indexOf("</article>");
console.log("\n=== ARTICLE END ===");
console.log(c.substring(Math.max(0, artEnd - 1000), artEnd));
